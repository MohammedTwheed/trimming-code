...
% 
% % Save logs to file
% fileID = fopen(fullfile(output_dir, 'logs.txt'), 'w');
% for i = 1:length(logs)
%     fprintf(fileID, '%s\n', logs{i});
% end
% fclose(fileID);
...
% 
% %% work on compare to nn ---Find all distinct diameters in D
% distinctDiameters = unique(D);
% 
% 
% 
% % 
% % random_values = 0.02 + (0.3-0.02) * rand(1, 5);
% % 
...
% end
% % End of script
% disp('Training and evaluation complete. Results and logs saved.');
