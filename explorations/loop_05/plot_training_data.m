...
% 
%   % Store BEP data
%   bepData = [bepData; bestFlowRate, bestEfficiency, currentDiameter];
% 
...
%        sprintf('%.2f', currentDiameter), 'FontSize', 10, 'VerticalAlignment', 'middle');
% 
%   % Mark and label the BEP on the curve
%   plot(bestFlowRate, bestEfficiency, 'ko', 'MarkerFaceColor', 'r');
%   text(bestFlowRate, bestEfficiency, sprintf('BEP %.2f', currentDiameter), ...
...
% bepTable = array2table(bepData, 'VariableNames', {'FlowRate_m3h', 'Efficiency', 'Diameter'});
...
%   text(bestFlowRate, bestHead, sprintf('BEP %.2f', currentDiameter), ...
%        'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
%   hold off;
% 
%   subplot(1, 3, 2);
...
%   text(bestFlowRate, bestPower, sprintf('BEP %.2f', currentDiameter), ...
%        'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
%   hold off;
% 
